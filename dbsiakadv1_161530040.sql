...
--
-- Host: 127.0.0.1
-- Generation Time: 27 Des 2017 pada 03.03
...
INSERT INTO `tbmahasiswa` (`nim`, `id_ta`, `kd_prodi`, `nama_mhs`, `jk`, `tmp_lahir`, `tgl_lahir`, `agama`, `nama_ayah`, `nama_ibu`, `alamat`, `no_telepon`, `foto`) VALUES
...
('ID002', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Administrator'),
('ID003', 'rohtiman', '58f38d1a57c08df3ea74adc851925d8e', 'Administrator'),
('ID004', 'user', 'ee11cbb19052e40b07aac0ca060c23ee', 'Staff Kemahasiswaan');
